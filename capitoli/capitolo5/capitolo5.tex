...
In questa sezione verranno descritti alcuni dettagli relativi all'implementazione realizzata quali il funzionamento dell'agnete `Postman', l'utilizzo di oggetti Java in tuProlog, la creazione delle intenzioni.
%TODO CAPIRE --> interrogazioni della teoria dell'agente tramite Alchemist. 
