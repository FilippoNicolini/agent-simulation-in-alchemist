...
\begin{itemize}
\item[1.] TimeDistribution, tramite invocazione del metodo \texttt{createTimeDistribution} implementato nella classe AgentIncarnation;
\item[2.] AgentReaction;
\item[3.] MovementAgent;
\item[4.] Condition, tramite invocazione del metodo \texttt{createCondition} implementato nella classe AgentIncarnation.
\end{itemize}
