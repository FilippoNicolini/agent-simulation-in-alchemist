...
\include{capitoli/capitolo5/capitolo5}

\include{capitoli/capitolo6/capitolo6}

\include{capitoli/capitolo7/capitolo7}
...
% provare anche questo comando:
%\addcontentsline{toc}{chapter}{\numberline{}{Bibliografia}}
\bibitem {JADE} \texttt{https://jade.tilab.com/}
\bibitem {Spade} \texttt{https://pypi.org/project/spade/}
\bibitem {Jason} \texttt{http://jason.sourceforge.net/wp/}
\bibitem {SARL} \texttt{http://www.sarl.io/}
\bibitem {JADEX} \texttt{https://www.activecomponents.org/\#/project/news}
\bibitem {Astra} \texttt{http://astralanguage.com/wordpress/}
\bibitem {tuProlog} \texttt{http://apice.unibo.it/xwiki/bin/view/Tuprolog/}
\bibitem {Alchemist} \texttt{http://alchemistsimulator.github.io}
\bibitem {Gradle} \texttt{https://gradle.org}
\end{thesitography}
